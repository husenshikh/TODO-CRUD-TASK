...
//         let getConfirm =confirm("Are you sure you want to remove this item?") //true or false
//         cl("getConfirm", getConfirm)
//         if (getConfirm) {
...
const todoAddHandler = (eve) => {
        ...
        // templating(todoArr); creat one li and add in UI
...
const onUpdateHandler = () => {
  ...
  //   if(todoObj.todoId=== getId) {
  //     todoObj.todoItem = updatedvalue
  //   }
  // })
